...
RemoveDir(current_dir+r'\high_exp_logs')
...
class MYDATA(Dataset):
    ...
    def normalize(self, data):
        origin_data=np.load(r".\DATA\High\train.npy")
...
model_path = current_dir+r'\high_model.pth'
model = Model()
...
writer = SummaryWriter(current_dir+r"\high_exp_logs")
...
torch.save(model.state_dict(), current_dir+r'\high_model_TL.pth')
