...
RemoveDir(current_dir+r'\high_logs')
...
train_dataset = MYDATA(np.load(r".\DATA\High\train.npy"))
...
writer = SummaryWriter(current_dir+r"\high_logs")
...
torch.save(model.state_dict(), current_dir+r'\high_model.pth')
