...
min_vals=np.min(np.load(r'./DATA/exp/train.npy'),axis=0)
max_vals=np.max(np.load(r'./DATA/exp/train.npy'),axis=0)
...
scatter = ax.scatter(x_values, a_values, predictions,label='prediction')
