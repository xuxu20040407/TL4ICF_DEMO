...
model_path = 'high_model.pth'
model = Model()
model.load_state_dict(torch.load(model_path))
# print(model.model1.0.weight.weight)

# 冻结除最后一层之外的所有参数
for name, param in model.named_parameters():
    # 假设最后一层的名字包含'linear_layer_4'，根据你的模型结构调整
...
writer = SummaryWriter(r".\high_exp_logs")
...
torch.save(model.state_dict(), 'high_model_TL.pth')
